  ...
  return (
    <>
      <Routes>
        ...
        <Route path="/customer-group/:groupId" element={
          <ProtectedRoute allowedRoles={['driver']}>
            <CustomerGroupDetail />
          </ProtectedRoute>
        } />
        <Route path="/customer-group/:groupId/signature" element={
          <ProtectedRoute allowedRoles={['driver']}>
        ...
        <Route path="/signature/:id" element={
          <ProtectedRoute allowedRoles={['driver']}>
            <SignatureCapture />
          </ProtectedRoute>
        } />
        <Route path="/customer-visits/:customerName/:routeNumber/:routeDate" element={
          <ProtectedRoute allowedRoles={['driver']}>
            <CustomerVisitDetail />
          </ProtectedRoute>
        } />
        <Route path="/customer-visits/:customerName/:routeNumber/:routeDate/signature" element={
          <ProtectedRoute allowedRoles={['driver']}>
